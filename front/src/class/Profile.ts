...
class Profile {
  ...
  public calcularIMC = () => {
    if (this.altura && this.peso)
      return CalculosMetabolicos.imc(this.altura, this.peso);
    return 0;
  };

  public adicionarAlimentoConsumido = (alimento: AlimentoDoDia) =>
    this.alimentosConsumidos.push(alimento);
  ...
  public getAlimentosConsumidos = (): AlimentoDoDia[] =>
  ...
  public setObjetivoPeso = (objetivoPeso: Objetivos) =>
